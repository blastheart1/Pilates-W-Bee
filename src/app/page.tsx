...
// Declare gtag as a global variable if it exists on the window
declare global {
  interface Window {
    gtag?: (...args: any[]) => void;
  }
...
export default function SinglePageApp() {
  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      quantity: 1,
      image:
        "src\PilatesShopImages\PilatesMat.jpg",
      type: "physical",
    },
    {
      id: 2,
      ...
      quantity: 2,
      image:
        "src\PilatesShopImages\images.avif",
      type: "physical",
    },
  ]);
  ...
  const products = [
    ...
    },
    {
      ...
      price: 1750,
      image:
        "/PilatesShopImages/PilatesBalls.png",
      type: "physical",
      stock: 20,
    },
    {
  ...
  const studioLocations = [
    {
      ...
      image:
        "Pilatesstudioimages/Studio1.jpeg",
      amenities: [
        "Private Showers",
        "Changing Rooms",
        "Equipment Storage",
    ...
    },
    {
      ...
      image:
        "Pilatesstudioimages/Studio2.jpeg",
      amenities: [
        "Outdoor Terrace",
        "Juice Bar",
        "Meditation Room",
  ...
  const certifications = [
    {
      name: "BASI Pilates",
      logo: "Certificates/BASI.png",
      color: "bg-pink-100",
    },
    {
      name: "Registered Nutritionist Dietitian",
      logo: "Certificates/NAD.png",
      color: "bg-green-100",
    },
    {
      name: "STOTT Pilates",
      logo: "Certificates/STOTT.png",
      color: "bg-blue-100",
    },
    {
      name: "Yoga Alliance",
      logo: "Certificates/YogaAlliance.png",
      color: "bg-orange-100",
    },
  ];
